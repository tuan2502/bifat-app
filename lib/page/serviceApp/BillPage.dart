                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              actions: [
                                ...
                                TextButton(
                                  onPressed: () async{
                                    var response = await UserServiceApi.orderService(orderModel);
                                    if (selectedPay == 0) {
                                      ...
                                      print('total: ${orderModel.totalPrice!.toDouble()}');
                                      String urlVnpay = await UserServiceApi.postCostFromVNPay(orderModel.totalPrice!.toDouble(), response.toString());
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) => PaymentPage(url: urlVnpay)));
                                    }else if (selectedPay == 2) {
                                      await UserServiceApi.postCostFromWallet(response.toString());
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) =>
