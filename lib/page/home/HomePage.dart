...
class _HomePageState extends State<HomePage> {
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Image.asset(
                                      'assets/images/logo.png', // Đường dẫn đến hình ảnh minh họa
                                      width: 80,
                                    ),
                                    IconButton(
  ...
  Future<dynamic> getUrlPayment() async {
    String response =
        await ApiHandler.postDataToWallet(double.parse(inputValue));
    return response;
  }

  Future<void> navigateToPaymentPage() async {
    final String urlVnpay = await getUrlPayment();
    Navigator.push(
      context,
      MaterialPageRoute(
