...
class LaundryCombo2Page extends StatefulWidget {
  const LaundryCombo2Page({Key? key}) : super(key: key);

  @override
  _LaundryCombo2PageState createState() => _LaundryCombo2PageState();
}

class _LaundryCombo2PageState extends State<LaundryCombo2Page> {
